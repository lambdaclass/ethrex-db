...
fn main() {
    ...
    println!("Added account at 0x{}", hex_encode(address));
    ...
    println!("\nStorage root: 0x{}", hex_encode(storage.root_hash()));
    ...
    println!("keccak256('hello world') = 0x{}", hex_encode(hash));
