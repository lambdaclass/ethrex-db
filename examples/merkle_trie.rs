...
fn main() {
    ...
    println!("Empty trie root: 0x{}", hex_encode(EMPTY_ROOT));
    ...
    println!("After account 1: 0x{}", hex_encode(root1));

    trie.insert(&key2, value2);
    let root2 = trie.root_hash();
    println!("After account 2: 0x{}", hex_encode(root2));

    trie.insert(&key3, value3);
    let root3 = trie.root_hash();
    println!("After account 3: 0x{}", hex_encode(root3));
    ...
    println!("New root: 0x{}", hex_encode(root4));
    ...
    println!("After deletion: 0x{}", hex_encode(root5));
    ...
    println!("Trie A root: 0x{}", hex_encode(root_a));
    println!("Trie B root: 0x{}", hex_encode(root_b));
